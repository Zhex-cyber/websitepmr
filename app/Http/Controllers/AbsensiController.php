    ...
    public function create()
{
    ...
    public function store(Request $request)
    {
        ...
        {
            $nis = Auth::user()->nis; // Mendapatkan nama lengkap anggota yang sedang login
    ...
    public function cetaklaporan(Request $request)
    {
        ...
        $tahun = $request->tahun;
        $namabulan = ["", "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"];
        $anggota = DB::table('users')->where('nis', $nis)
    ...
    public function izinsakit(Request $request)
    {
        ...
        $query->select('pengajuan_izin.id', 'tgl_izin', 'pengajuan_izin.nis', 'users.name as nama_lengkap',  'pengajuan_izin.status', 'status_approved', 'keterangan');
        $query->join('users', 'pengajuan_izin.nis', '=', 'users.nis');
