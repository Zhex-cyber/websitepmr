    ...
    public function detailKegiatan($slug)
{
    ...
    // Mengambil kegiatan lain untuk ditampilkan (optional)
    $kegiatanOther = Kegiatan::where('is_active', '0')->orderBy('created_at', 'desc')->get();

    return view('frontend.content.kegiatanDetail', compact('kegiatan', 'kegiatanOther', 'berita', 'jurusanM', 'kegiatanM', 'footer'));
