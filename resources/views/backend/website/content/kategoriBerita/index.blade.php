                                        ...
                                        <tbody>
                                           @foreach ($kategori as $key => $kategoris)
                                               <tr>
                                                   ...
                                                   <td class="d-flex">
                                                       <a href=" {{route('backend-kategori-berita.edit', $kategoris->id)}} " class="btn btn-warning btn-sm">Edit</a>
                                                       <form action="{{route('kategori.hapus' , $kategoris->id)}}"method="POST">
                                                        <button style="margin-left: 5px" type="submit"  class="btn btn-danger btn-sm" id="delete">Hapus</button>
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                   </td>
