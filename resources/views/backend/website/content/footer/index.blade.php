                        ...
                        <div class="card-body">
                            <form action=" {{route('backend-footer.store')}} " method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label for="basicInput">Logo PMR</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="basicInput">Deskripsi Singkat PMR WIRA SMKN 1 KAWALI</label> <span class="text-danger">*</span>
                    ...
                    <div class="card-body">
                        <form action=" {{route('backend-footer.update', $footer->id)}} " method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="basicInput">Deskripsi Singkat website PMR WIRA SMKN 1 KAWALI</label> <span class="text-danger">*</span>
