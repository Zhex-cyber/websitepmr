                                            ...
                                            @foreach ($image as $key => $images)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        ...
                                                        <form id="form-delete-{{ $images->id }}" action="{{ route('image.hapus', $images->id) }}" method="POST" style="margin-left: 5px;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $images->id }}">Hapus</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action=" {{route('backend-imageslider.store')}} " method="post" enctype="multipart/form-data">
                                        ...
                                        <a href="{{route('backend-imageslider.index')}}" class="btn btn-danger">Batal</a>
                                    </form>
                                </div>
                            </div>
                        </div>
