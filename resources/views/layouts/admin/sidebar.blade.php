    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu {{ request()->is(['absensi/laporan','absensi/rekap']) ? 'show' : '' }}">
              <div class="dropdown-menu-columns">
                  <div class="dropdown-menu-column">
                      <a class="dropdown-item {{ request()->is(['absensi/laporan']) ? 'active' : '' }}" href="/absensi/laporan">
                          Absensi
                      </a>
                      <a class="dropdown-item {{ request()->is(['absensi/rekap']) ? 'active' : '' }}" href="/absensi/rekap">
                          Rekap Absensi
                      </a>
                  </div>
              </div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu  {{ request()->is(['konfigurasi','konfigurasi/*']) ? 'show' : '' }}">
                <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                        <a class="dropdown-item  {{ request()->is(['konfigurasi/lokasiabsen']) ? 'active' : '' }}" href="/konfigurasi/lokasiabsen">
                            Lokasi Absen
                        </a>
                    </div>
                </div>
